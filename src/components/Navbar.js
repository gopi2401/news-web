...
function Navbar() {
  ...
  const { Countrie } = React.useContext(DataContext);

  const countrieArr = ['us', 'in'];
  const SelectContry = () => {
    const x = document.getElementById("countries").value;
    Countrie.setCountrie(x);
  ...
  return (
    <div className=''>
      <nav className="block relative w-full max-w-screen-lg px-4 py-2 mx-auto text-white bg-white shadow-md rounded-md lg:px-8 lg:py-3 mt-10">
        <div className='container flex items-center mx-auto gap-x-2'>
          ...
          <div>
            ...
            <select defaultValue={Countrie.Country} onChange={SelectContry} id="countries" className="uppercase bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
              {countrieArr.map(c => (
