...
function NewsCard({ article }) {
  return (
    <div class="max-w-lg bg-white overflow-y-hidden overflow-x-hidden border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <div className='flex justify-center items-center'> <a href={article.url} target="_blank" rel="noopener noreferrer">
        <img class="rounded-t-lg max-w-lg object-contain" src={article.urlToImage} alt={article.title} />
      </a></div>
      <div class="p-5">
