    ...
    <>
      <div className='flex flex-col items-center'>
        ...
        <nav className="inline-flex items-center p-1 my-5 rounded bg-white space-x-2">
          <button onClick={() => handlePagination(-(currentPage - 1))} className="p-1 rounded border text-gray-500 bg-white hover:text-white hover:bg-blue-600 hover:border-blue-600" href="#">
            first
          </button>
          <button onClick={() => handlePagination(-1)} className="p-1 rounded border text-black bg-white hover:text-white hover:bg-blue-600 hover:border-blue-600" href="#">
          ...
          <button onClick={() => handlePagination(totalPage - currentPage)} className="p-1 rounded border text-gray-500 bg-white hover:text-white hover:bg-blue-600 hover:border-blue-600" href="#">
            last
          </button>
        </nav>
      </div>
